    ...
    return(
        <div className="backgroundTrama">
            <div className="terminosCondiciones container">
                ...
                <p>
                    La presente Política de Privacidad establece los términos en que La Casa 1895
                    Entertainment S.A.C. usa y protege la información que es proporcionada por 
                    ...
                    identificado, lo hacemos asegurando que sólo se empleará de acuerdo con los 
                    términos de este documento. Sin embargo, esta Política de Privacidad puede 
                    cambiar con el tiempo o ser actualizada por lo que le recomendamos y 
                    enfatizamos revisar continuamente esta página para asegurarse que está de 
                    acuerdo con dichos cambios.<br/> <br />
                    <h5><strong>Información que es Recogida</strong></h5>
                    ...
                    entrega o facturación. <br/> <br/>
                    <h5><strong>Uso de la Información Recogida</strong></h5>
                    ...
                    pedidos en caso de que aplique y mejorar nuestros productos y servicios. 
                    Es 
                    posible que sean enviados correos electrónicos periódicamente a través de 
                    nuestro sitio con ofertas especiales, nuevos productos u otra información 
                    ...
                    La Casa 1895 Entertainment S.A.C. está altamente comprometido para cumplir 
                    ...
                    exista ningún acceso no autorizado.<br/> <br/>
                    ...
                    también facilita las futuras recurrentes. Otra función que tienen las cookies es 
                    que con ellas nuestra página web pueda reconocerte individualmente y por 
                    tanto brindarte el mejor servicio personalizado.
                    Nuestro 
                    sitio web
                    www.cineviajeros.com emplea las cookies para poder 
                    identificar las páginas que son visitadas y su frecuencia. Esta información es 
                    empleada únicamente para análisis estadístico y después la información se elimina de forma permanente. Usted puede eliminar las cookies en cualquier 
                    momento desde su ordenador. Sin embargo, las cookies ayudan a proporcionar
                    un mejor servicio de los sitios web, estás no dan acceso a información de su 
                    ordenador ni de usted, a menos de que usted así lo quiera y la proporcione 
                    directamente. Usted puede aceptar o negar el uso de cookies, es importante 
                    indicar que la mayoría de los navegadores aceptan cookies automáticamente 
                    ...
                    posible que no pueda utilizar algunos de nuestros servicios.<br/> <br/>
                    <h5><strong>Enlaces a Terceros</strong></h5>
                    Este sitio web puede contener enlaces a otros sitios que pudieran ser de su 
                    ...
                    confirmar que usted está de acuerdo con estas.<br/> <br/>
                    <h5><strong>Contro de su Información Personal</strong></h5>
                    En cualquier momento usted puede restringir la recopilación o el uso de la 
                    información personal que es proporcionada a nuestro sitio web.
                    Cada vez que 
                    ...
                    orden judicial.
                    La Casa 1895 Entertainment S.A.C. a través de la marca registrada 
                    Cineviajeros, se reserva el derecho de cambiar los términos de la presente 
